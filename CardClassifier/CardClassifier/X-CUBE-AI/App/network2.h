...
#define AI_NETWORK2_INPUTS_IN_ACTIVATIONS   (4)
#define AI_NETWORK2_OUTPUTS_IN_ACTIVATIONS  (4)
...
#define AI_NETWORK2_IN \
  ai_network2_inputs_get(AI_HANDLE_NULL, NULL)
...
#define AI_NETWORK2_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK2_IN_1_HEIGHT      (128)
#define AI_NETWORK2_IN_1_WIDTH       (128)
#define AI_NETWORK2_IN_1_CHANNEL     (3)
#define AI_NETWORK2_IN_1_SIZE        (128 * 128 * 3)
#define AI_NETWORK2_IN_1_SIZE_BYTES  (196608)
...
#define AI_NETWORK2_OUT \
  ai_network2_outputs_get(AI_HANDLE_NULL, NULL)
...
#define AI_NETWORK2_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_NETWORK2_OUT_1_CHANNEL     (54)
#define AI_NETWORK2_OUT_1_SIZE        (54)
#define AI_NETWORK2_OUT_1_SIZE_BYTES  (216)
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network2_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_network2_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
